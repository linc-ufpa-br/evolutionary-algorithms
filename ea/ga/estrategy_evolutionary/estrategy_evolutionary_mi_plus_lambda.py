import copy
class EstrategyEvolutionaryMiPlusLambda():
    
    def __init__(self, population, individual_class, mutation, crossover, stop_criterion, survivor_selection, parent_selection, population_model, function_fitness, type_fitness, mi, lam):
    ...
    def execute(self):
        ...
        while self.__stop_criterion.continue_generation():
            ...
            new_population = []
            parents = self.__parent_selection.selection(self.__lam, self.__population)
            for parent in parents:
                children = [parent[0].chromossome, parent[1].chromossome]
            ...
            survivors = self.__survivor_selection.replace_population([total_population, new_population], self.__mi)
