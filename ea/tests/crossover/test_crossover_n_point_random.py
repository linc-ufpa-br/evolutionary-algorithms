...
import sys
sys.path.append("../../")
from ga.crossover.crossover_n_point_random import CrossoverNPointRandom
from unittest.mock import MagicMock

class TestCrossoverNPointRandom(unittest.TestCase):
    ...
    def test_children_list_is_equal_then_list_expected(self):
        ...
        random_numbers = [3 ,0, 2, 4] # lista contendo elementos aleatorios
        ...
        probability = 0.9
        crossover = CrossoverNPointRandom(random_generator, probability)
