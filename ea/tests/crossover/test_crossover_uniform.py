...
import sys
sys.path.append("../../")
from ga.crossover.crossover_uniform import CrossoverUniform
...
class TestCrossoverUniform(unittest.TestCase):
    ...
    def test_children_list_is_equal_then_list_expected(self):
        ...
        random_numbers = [0 ,1, 1, 0, 0] # lista contendo elementos aleatorios
        ...
        parent_1 = [0, 1, 0, 1, 0]
        parent_2 = [1, 0, 0, 0, 1]
        child_1_expected = [0, 0, 0, 1, 0]
        child_2_expected = [1, 1, 0, 0, 1]
        list_expected = (child_1_expected, child_2_expected)
        probability= 0.9
        crossover = CrossoverUniform(random_generator, probability)
