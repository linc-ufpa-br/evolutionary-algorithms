...
import sys
sys.path.append("../../")
from ga.crossover.crossover_whole_arithmetic import CrossoverWholeArithmetic
from unittest.mock import MagicMock

class TestCrossoverWholeArithmetic(unittest.TestCase):
    ...
    def test_children_list_is_equal_then_list_expected(self):
        ...
        parent_1 = [0, 1, 1, 1, 0]
        parent_2 = [1, 0, 1, 0, 1]
        child_1_expected = [0.5, 0.5, 1.0, 0.5, 0.5]
        child_2_expected = [0.5, 0.5, 1.0, 0.5, 0.5]
        list_expected = (child_1_expected, child_2_expected)
        probability = 0.9 
        crossover = CrossoverWholeArithmetic(random_generator, probability)
